                ...
                <div className="flex flex-col">
                    ...
                    <div className="bg-[#003554] h-auto lg:h-screen lg:max-h-[50vh] w-screen max-w-[80vw] flex lg:flex-row flex-col m-auto">
                        ...
                        <div className="w-screen max-w-[70vw] flex flex-col ml-[30px] justify-center">
                            <h2 className="lg:text-[38px] md:text-[34px] text-[30px] font-bold pt-[20px] lg:text-left text-center">{name}</h2><br />
                            ...
                            <div className='text-center'>
                                <a href={website} target="_blank" className="inline-block w-[80px] h-[30px] border rounded-[20px] lg:ml-[20vw] text-center pt-[3px] transition ease-in-out duration-200 hover:bg-white hover:text-[#051923] lg:mb-0 mb-5">Visit</a>
                            </div>
                        </div>
                    </div>
                    <br />
